Voting application based on python connects to redis in-memory db to backed code writted on .NET which update the persistent postgres DB and displays the results in node based web ui.
